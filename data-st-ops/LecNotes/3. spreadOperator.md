...
- The spread operator is denoted by 3 dots: ...
- The spread operator is used to unpack an array or object into a list of elements.
- The spread operator is used to create a shallow copy of an array or object.
- The spread operator is used to merge multiple arrays or objects into one.
- The spread operator is used to pass multiple arguments to a function.
